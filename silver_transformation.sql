CREATE STREAMING LIVE TABLE silver.sales
AS
select
...
from lakeflow_dlt_uc.bronze.sales;
...
from lakeflow_dlt_uc.bronze.customers;
...
from lakeflow_dlt_uc.bronze.products;
...
from lakeflow_dlt_uc.bronze.regions;
